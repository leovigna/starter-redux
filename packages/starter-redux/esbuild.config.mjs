...
await esbuild.default.build({
    ...
    bundle: true,
    minify: false,
    outfile: 'dist/starter-redux-lib.cjs.js',
    format: 'cjs',
...
await esbuild.default.build({
    ...
    bundle: true,
    minify: true,
    outfile: 'dist/starter-redux-lib.cjs.min.js',
    format: 'cjs',
    external: ['url', 'events', 'path'],
    ...baseConfig,
});
...
await esbuild.default.build({
    ...
    bundle: true,
    minify: false,
    outfile: 'dist/starter-redux-lib.es.js',
    format: 'esm',
...
await esbuild.default.build({
    ...
    bundle: true,
    minify: true,
    outfile: 'dist/starter-redux-lib.es.min.js',
    format: 'esm',
    external: ['path', 'events', 'url'],
    ...baseConfig,
});
